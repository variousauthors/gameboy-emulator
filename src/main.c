...
/* Cx */ {NOOP, STCK, NOOP, JP16, NOOP, STCK, ARIM, NOOP, NOOP, CALL, NOOP, PREF, NOOP, CALL, ARIM, NOOP},
/* Fx */ {NOOP, STCK, NOOP, NOOP, NOOP, STCK, ARIM, NOOP, NOOP, CALL, NOOP, NOOP, NOOP, NOOP, ARIM, NOOP},
/* Ex */ {LDH3, STCK, LDH3, NOOP, NOOP, STCK, ARIM, NOOP, NOOP, CALL, LDH3, NOOP, NOOP, NOOP, ARIM, NOOP},
